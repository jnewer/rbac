...
<script>
    ...
    <section class="Hui-article-box">
        <nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="/" class="maincolor">首页</a> <span
                class="c-999 en">&gt;</span><span class="c-666">角色添加</span> <a class="btn btn-success radius r"
        ...
        <div class="Hui-article">
            <article class="cl pd-20">
                <form action="<?php echo U('/Home/Role/addHandler');?>" method="post" class="form form-horizontal"
                      id="form-admin-role-add">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名称：</label>
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="" placeholder="" id="role_name"
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <?php if(is_array($nodeTree)): $i = 0; $__LIST__ = $nodeTree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl class="permission-list">
                                    <dt>
                                        <label>
                                    ...
                                    <dd>
                                        <dl class="cl permission-list2">
                                            <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dt>
                                                    <label class="">
                                                        <input
                                                        <?php if(in_array($v['id'],$my_node_list)): ?>checked="checked"<?php endif; ?>
